...
export const BLOCKS = [
  ...
  { name: 'The Pages Nobody Wrote', sub: 'The notebook grows them by itself. Lately they are not from here.' },
];
...
export const JOBS = [
  // ================= BLOCK 1 — THE ROUTE =================
  {
    ...
    hero: [{ k: 'church', x: -14, z: 56, s: 1.15 }, { k: 'tower', x: 52, z: -46, s: 1.0 }],
    palette: { arc: true, sky: 0xf4f8ff, fog: 0xd9e8ec, hemi: 0xdceaf6, sun: 0xfff5e4, hemiI: 0.90, sunI: 1.60, fogNear: 34, fogFar: 165 },
  ...
  },
  {
    ...
    hero: [{ k: 'school', x: 10, z: 50, s: 1.05 }, { k: 'tower', x: -52, z: 30, s: 0.9 }],
    palette: { arc: true, sky: 0xfbfdff, fog: 0xd2e7e0, hemi: 0xe2f2fa, sun: 0xfffbe8, hemiI: 0.92, sunI: 1.78, fogNear: 40, fogFar: 175 },
  ...
  },
  {
    ...
    hero: [{ k: 'tower', x: -10, z: 58, s: 1.1 }, { k: 'elevator', x: 66, z: 34, s: 0.95 }],
    palette: { arc: true, sky: 0xe9f3ff, fog: 0xcfe2ec, hemi: 0xd6ecf8, sun: 0xfff6de, hemiI: 0.85, sunI: 1.70, fogNear: 44, fogFar: 190 },
  ...
  },
  {
    ...
    hero: [{ k: 'hospital', x: -44, z: -46, s: 0.95 }, { k: 'church', x: 22, z: 62, s: 0.95 }],
    palette: { arc: true, sky: 0xe6e8e6, fog: 0xd4dad6, hemi: 0xe2e8e4, sun: 0xf7f3e8, hemiI: 1.00, sunI: 1.25, fogNear: 30, fogFar: 140 },
  ...
  },
  {
    ...
    hero: [{ k: 'civic', x: 4, z: 52, s: 1.0 }, { k: 'church', x: 58, z: 20, s: 0.9 }],
    palette: { arc: true, sky: 0xf6faff, fog: 0xd8e6ec, hemi: 0xdcedf6, sun: 0xfff6e2, hemiI: 0.88, sunI: 1.68, fogNear: 36, fogFar: 170 },
  ...
  // ================= BLOCK 2 — THE FAVORS =================
  {
    ...
    hero: [{ k: 'mill', x: -12, z: 48, s: 0.95 }, { k: 'civic', x: 48, z: -44, s: 0.85 }],
    palette: { arc: true, sky: 0xffeeda, fog: 0xf0dcc0, hemi: 0xffe8cc, sun: 0xffe2b4, hemiI: 0.80, sunI: 1.50, fogNear: 26, fogFar: 130 },
  ...
  },
  {
    ...
    hero: [{ k: 'school', x: 34, z: 56, s: 0.95 }, { k: 'tower', x: -46, z: -42, s: 0.9 }],
    palette: { arc: true, sky: 0xf2f7ee, fog: 0xd8e4d0, hemi: 0xe4f0e0, sun: 0xfff4d8, hemiI: 0.86, sunI: 1.66, fogNear: 34, fogFar: 160 },
  ...
  },
  {
    ...
    hero: [{ k: 'elevator', x: 18, z: 66, s: 1.05 }, { k: 'church', x: -58, z: -40, s: 0.85 }],
    palette: { arc: true, sky: 0xf4efdd, fog: 0xe4dcc2, hemi: 0xf0ecd8, sun: 0xfff2ca, hemiI: 0.82, sunI: 1.62, fogNear: 24, fogFar: 135 },
  ...
  },
  {
    ...
    hero: [{ k: 'mill', x: -24, z: 60, s: 0.9 }, { k: 'radio', x: 58, z: 30, s: 0.9 }],
    palette: { arc: true, sky: 0xeceeea, fog: 0xd8dcd4, hemi: 0xe2e8e0, sun: 0xf8f2e0, hemiI: 0.95, sunI: 1.35, fogNear: 32, fogFar: 145 },
  ...
  },
  {
    ...
    hero: [{ k: 'bridge', x: 4, z: 46, s: 1.05 }, { k: 'elevator', x: 64, z: -22, s: 0.85 }],
    palette: { arc: true, sky: 0xe6f2f5, fog: 0xc9dee4, hemi: 0xd4ecf4, sun: 0xfff4e0, hemiI: 0.95, sunI: 1.50, fogNear: 20, fogFar: 115 },
  ...
  // ================= BLOCK 3 — THE RESCUES =================
  {
    ...
    hero: [{ k: 'church', x: -8, z: 54, s: 1.0 }, { k: 'hospital', x: 60, z: -40, s: 0.85 }],
    palette: { arc: true, sky: 0xe8e8de, fog: 0xd6d6c6, hemi: 0xdee2d4, sun: 0xf6f0d6, hemiI: 0.90, sunI: 1.42, fogNear: 28, fogFar: 135 },
  ...
  },
  {
    ...
    hero: [{ k: 'tower', x: 30, z: 58, s: 1.0 }, { k: 'school', x: -48, z: -44, s: 0.85 }],
    palette: { arc: true, sky: 0xfff6e0, fog: 0xe8dcbc, hemi: 0xffeeca, sun: 0xfff0c0, hemiI: 0.75, sunI: 1.80, fogNear: 30, fogFar: 150 },
  ...
  },
  {
    ...
    hero: [{ k: 'church', x: 12, z: 50, s: 1.05 }, { k: 'civic', x: -54, z: 24, s: 0.85 }],
    palette: { arc: true, sky: 0xeef4e6, fog: 0xd6e2ca, hemi: 0xdcf0d4, ground: 0x4a6b36, sun: 0xfff4d4, hemiI: 0.95, sunI: 1.55, fogNear: 26, fogFar: 130 },
  ...
  },
  {
    ...
    hero: [{ k: 'church', x: -20, z: 56, s: 1.0 }, { k: 'mill', x: 52, z: -46, s: 0.85 }],
    palette: { arc: true, sky: 0xeceff0, fog: 0xd9dedb, hemi: 0xe4eaea, sun: 0xf9f4e6, hemiI: 1.00, sunI: 1.30, fogNear: 28, fogFar: 140 },
  ...
  },
  {
    ...
    hero: [{ k: 'church', x: -4, z: 40, s: 1.25, rot: 3.1416 }, { k: 'elevator', x: 64, z: 48, s: 0.9 }],
    palette: { arc: true, sky: 0xdfeeff, fog: 0xc9e0ea, hemi: 0xd8eef8, sun: 0xfff8e4, hemiI: 0.88, sunI: 1.70, fogNear: 44, fogFar: 200 },
  ...
  // ================= BLOCK 4 — THE LANDMARKS =================
  {
    ...
    hero: [{ k: 'tower', x: -20, z: 70, s: 1.15 }, { k: 'elevator', x: 72, z: -30, s: 0.9 }],
    palette: { arc: true, sky: 0xdfeeff, fog: 0xc9e0f0, hemi: 0xd8eefc, sun: 0xfff8e6, hemiI: 0.90, sunI: 1.72, fogNear: 46, fogFar: 200 },
    tiers: [{ t: 'base', tier: 3 }],
    props: [
  ...
  },
  {
    ...
    hero: [{ k: 'civic', x: 0, z: 50, s: 1.2 }, { k: 'church', x: -52, z: 40, s: 0.95 }, { k: 'tower', x: 70, z: -30, s: 0.85 }],
    palette: { arc: true, sky: 0xf0f6ff, fog: 0xd4e4ee, hemi: 0xdcecf8, sun: 0xfff8e8, hemiI: 0.88, sunI: 1.70, fogNear: 48, fogFar: 210 },
  ...
  },
  {
    ...
    hero: [{ k: 'tower', x: 9, z: 30, s: 1.3, band: 0x4f7a8a }, { k: 'church', x: -56, z: 62, s: 0.8 }, { k: 'elevator', x: 68, z: -44, s: 0.8 }],
    palette: { arc: true, sky: 0xffeecc, fog: 0xf0d2a4, hemi: 0xffe6c4, sun: 0xffdca8, hemiI: 0.80, sunI: 1.50, fogNear: 40, fogFar: 220 },
  ...
  // ================= FINALE =================
  {
    ...
    hero: [{ k: 'tower', x: 38, z: 52, s: 0.95, lift: 0.20 }],
    palette: { arc: true, sky: 0xffeed6, fog: 0xecd2b0, hemi: 0xf6dfc2, sun: 0xffe8c0, hemiI: 0.85, sunI: 1.45, fogNear: 30, fogFar: 150 },
  ...
  // ================= ODD JOBS =================
  {
    ...
    hero: [{ k: 'radio', x: 52, z: 52, s: 1.0 }, { k: 'tower', x: -46, z: -38, s: 0.85 }],
    palette: { arc: true, sky: 0xfff4e2, fog: 0xe8dcc4, hemi: 0xfff0d4, sun: 0xfff2c8, hemiI: 0.80, sunI: 1.75, fogNear: 34, fogFar: 160 },
  ...
  },
  {
    ...
    hero: [{ k: 'church', x: -8, z: 46, s: 0.95, lift: 0.12 }, { k: 'radio', x: 56, z: -30, s: 0.9, lift: 0.10 }],
    palette: { hemi: 0x3d4a70, ground: 0x1b2416, fogNear: 34, fogFar: 130 },
    tiers: [{ t: 'base', tier: 3 }],
    props: [
  ...
  },
  {
    ...
    // two of the same water tower, at mirrored bearings. Nobody remarks on it.
    hero: [{ k: 'tower', x: -38, z: 44, s: 0.9, lift: 0.20 }, { k: 'tower', x: 38, z: 44, s: 0.9, lift: 0.20 }],
    palette: { fogNear: 28, fogFar: 115 },
...
export function dailyDef(dateStr) {
  ...
  // today's page is somewhere in Hazel Park, so today's page can see one of its landmarks
  const HK = ['tower', 'church', 'elevator', 'mill', 'school', 'civic', 'hospital', 'radio'];
  const hero = [{ k: HK[(rng() * HK.length) | 0], x: -46 + rng() * 92, z: 44 + rng() * 22, s: 0.85 + rng() * 0.3 }];
  const hour = rng();   // and its own hour of the morning
  const pal = { arc: true, hemiI: 0.84 + hour * 0.12, sunI: 1.42 + hour * 0.34, fogNear: 26 + hour * 20, fogFar: 130 + hour * 70 };
  return {
